...
#| cache: true
#| echo: false
#| fig-cap: Histogrammes de 10 échantillons aléatoires simples de taille 20 tirés d'une loi uniforme.
#| fig-width: 8
#| fig-height: 4.5
#| out-width: 80%
set.seed(1234)
...
- Modèle 2: régression binomiale ou binomiale négative. Données `BL22_L`, paquet `hecedsm`.
...
ggplot(data = samp,
  ...
  geom_point() +
  geom_jitter() +
  labs(col = "échantillon", y = "", x = "numéro d'échantillon") +
...
- (5) Les valeurs-$p,$ ou la significativité statistique, ne mesurent pas la taille de l'effet ou l'importance d'un résultat.
...
\begin{align*}
\Pr{\!}_a(\text{rejeter} \mathscr{H}_0),
\end{align*}
...
## 6. Conclure dans le cadre du problème
